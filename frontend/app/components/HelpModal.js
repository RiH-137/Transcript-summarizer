        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Step 1: Upload Your Content</h4>
              <p className="text-gray-800 text-sm">Upload text files (PDF, DOCX, TXT) or audio files (MP3, WAV, M4A) up to 100MB.</p>
            </div>
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Step 2: Choose Your Settings</h4>
              <p className="text-gray-800 text-sm">Select summarization mode (Concise/Detailed) and persona (Developer/Manager/Client).</p>
            </div>
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Step 3: Generate & Analyze</h4>
              <p className="text-gray-800 text-sm">Get AI-powered summaries, sentiment analysis, and key insights instantly.</p>
            </div>
          </div>
        </div>
      )
    ...
    'file-upload': {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
            <h4 className="font-semibold text-gray-900 mb-2">Processing Tips</h4>
    ...
    'ai-features': {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-gray-500 pl-4 bg-gray-100 py-3 pr-4 rounded-r-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Summarization Modes</h4>
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <span className="text-gray-800 mt-1">■</span>
                  <div>
                    <p className="font-medium text-gray-900">Concise Mode</p>
                    <p className="text-sm text-gray-700">Brief summaries highlighting only key points</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-gray-800 mt-1">■</span>
                  <div>
                    <p className="font-medium text-gray-900">Detailed Mode</p>
                    <p className="text-sm text-gray-700">Comprehensive summaries with sections and bullet points</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-700 mb-3">Generate summaries in multiple languages:</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-gray-200 text-gray-800 text-xs rounded-full border border-gray-300">English</span>
                <span className="px-3 py-1 bg-gray-200 text-gray-800 text-xs rounded-full border border-gray-300">Spanish</span>
                <span className="px-3 py-1 bg-gray-200 text-gray-800 text-xs rounded-full border border-gray-300">French</span>
                <span className="px-3 py-1 bg-gray-200 text-gray-800 text-xs rounded-full border border-gray-300">German</span>
                <span className="px-3 py-1 bg-gray-200 text-gray-800 text-xs rounded-full border border-gray-300">And more...</span>
              </div>
            </div>
    ...
    'troubleshooting': {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Upload Failed</h4>
            ...
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Processing Takes Too Long</h4>
              <ul className="text-sm text-gray-700 space-y-1">
            ...
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              <h4 className="font-semibold text-gray-900 mb-2">Poor Quality Results</h4>
              <ul className="text-sm text-gray-700 space-y-1">
            ...
            <div className="bg-gray-100 border-l-4 border-gray-500 p-4 rounded-r-lg">
              ...
              <div className="space-y-1">
                <a href="mailto:101rishidsr@gmail.com" className="text-gray-800 hover:text-gray-800 text-sm block">Email Support</a>
                <a href="https://github.com/RiH-137/Transcript-summarizer" className="text-gray-800 hover:text-gray-800 text-sm block">Report Issues</a>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
              ...
              <div className="space-y-3 text-sm font-mono">
                <div className="flex items-center space-x-3 p-2 bg-white rounded border">
                  <span className="px-2 py-1 bg-gray-200 text-gray-800 rounded text-xs font-sans">POST</span>
            ...
            <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">AI Models Used</h4>
              <ul className="text-sm text-gray-700 space-y-2">
            ...
            <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg">
              ...
              <div className="space-y-2">
                <a href="https://github.com/RiH-137/Transcript-summarizer/blob/master/README.md" 
                   className="text-gray-800 hover:text-gray-800 text-sm block">Full Documentation</a>
                <a href="https://console.groq.com/playground" 
                   className="text-gray-800 hover:text-gray-800 text-sm block">Groq API Playground</a>
                <a href="https://github.com/RiH-137/Transcript-summarizer" 
                   className="text-gray-800 hover:text-gray-800 text-sm block">Source Code</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] flex overflow-hidden border border-gray-200">
        ...
        <div className="w-72 bg-gray-50 bg-opacity-90 backdrop-blur-sm border-r border-gray-200 p-6 overflow-y-auto">
            ...
            {Object.entries(helpSections).map(([key, section]) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-lg transition-all duration-200 flex items-center space-x-3 ${
                  activeSection === key
                    ? 'bg-gray-200 text-gray-700 border-l-4 border-gray-500 shadow-sm'
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="bg-gray-100 border border-gray-300 p-4 rounded-lg">
              <p className="text-xs text-gray-700 mb-2 font-medium">Need more help?</p>
              <a href="mailto:101rishidsr@gmail.com" 
                 className="text-xs text-gray-800 hover:text-gray-800 font-medium transition-colors">
                Contact Support
              </a>
            </div>
          </div>
