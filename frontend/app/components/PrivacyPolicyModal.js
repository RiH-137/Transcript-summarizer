  ...
  return (
    <div className="fixed inset-0 bg-opacity-10 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden border border-gray-200">
        {/* Header */}
        <div className="bg-gray-100 bg-opacity-90 border-b border-gray-300 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Privacy Policy & Technical Details</h2>
              <p className="text-sm text-gray-700 mt-1">Understanding how AppleDesk protects your data and operates</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="space-y-8">
            ...
            <section>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <span className="w-8 h-8 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold mr-3">1</span>
                Privacy-Focused Temporary Storage
              </h3>
              <div className="bg-gray-100 border-l-4 border-gray-500 p-6 rounded-r-lg">
                <h4 className="font-semibold text-gray-900 mb-3">How We Handle Your Files</h4>
                <div className="space-y-3 text-gray-800">
                  <div className="flex items-start space-x-3">
                    <span className="text-gray-800 mt-1">▪</span>
                    <div>
                      <p className="font-medium">Temporary Storage Only</p>
                      <p className="text-sm text-gray-700">Files are stored temporarily in our server&apos;s &apos;uploads&apos; directory during processing and automatically deleted immediately after processing completes.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="text-gray-800 mt-1">▪</span>
                    <div>
                      ...
                      <p className="text-sm text-gray-700">We do not maintain any database or permanent storage of your documents, transcripts, or summaries.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <span className="text-gray-800 mt-1">▪</span>
                    <div>
                      ...
                      <p className="text-sm text-gray-700">Each session is independent, and no data persists between sessions or users.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <span className="w-8 h-8 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold mr-3">2</span>
                Nodemailer Email Service
              </h3>
              <div className="bg-gray-100 border-l-4 border-gray-500 p-6 rounded-r-lg">
                <h4 className="font-semibold text-gray-900 mb-3">What is Nodemailer?</h4>
                <div className="space-y-3 text-gray-800">
            ...
            <section>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <span className="w-8 h-8 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold mr-3">3</span>
                Real-time Progress Tracking
              </h3>
              <div className="bg-gray-100 border-l-4 border-gray-500 p-6 rounded-r-lg">
                <h4 className="font-semibold text-gray-900 mb-3">How Progress Tracking Works</h4>
                <div className="space-y-4 text-gray-800">
                  <div className="bg-white p-4 rounded-lg border border-gray-300">
                    <h5 className="font-medium text-gray-900 mb-2">File Upload Progress</h5>
                    <p className="text-sm text-gray-700">Real-time upload progress bars show file transfer status using JavaScript FileReader API and server-side progress events.</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border border-gray-300">
                    <h5 className="font-medium text-gray-900 mb-2">AI Processing Status</h5>
                    <p className="text-sm text-gray-700">Live updates during transcription, summarization, and analysis phases using WebSocket-like status polling.</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border border-gray-300">
                    <h5 className="font-medium text-gray-900 mb-2">Processing Stages</h5>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <span className="px-2 py-1 bg-gray-200 text-gray-800 text-xs rounded-full">File Upload</span>
                      <span className="px-2 py-1 bg-gray-200 text-gray-800 text-xs rounded-full">Text Extraction</span>
                      <span className="px-2 py-1 bg-gray-200 text-gray-800 text-xs rounded-full">AI Analysis</span>
                      <span className="px-2 py-1 bg-gray-200 text-gray-800 text-xs rounded-full">Results Ready</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <span className="w-8 h-8 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold mr-3">4</span>
                Export to RTF (Rich Text Format)
              </h3>
              <div className="bg-gray-100 border-l-4 border-gray-500 p-6 rounded-r-lg">
                <h4 className="font-semibold text-gray-900 mb-3">What is RTF Export?</h4>
                <div className="space-y-4 text-gray-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg border border-gray-300">
                      <h5 className="font-medium text-gray-900 mb-2">Compatibility</h5>
                      <ul className="text-sm text-gray-700 space-y-1">
            ...
            <section>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <span className="w-8 h-8 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold mr-3">5</span>
              ...
              <div className="bg-gray-100 border-l-4 border-gray-500 p-6 rounded-r-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <h5 className="font-medium text-gray-900">Technical Stack</h5>
                    <ul className="text-sm text-gray-700 space-y-1">
